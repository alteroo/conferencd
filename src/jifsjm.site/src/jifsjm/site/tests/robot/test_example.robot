...
#
#  $ bin/test -s jifsjm.site -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src jifsjm.site.testing.JIFSJM_SITE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/jifsjm/site/tests/robot/test_example.robot
#
