...
def prep_front_page():
    ...
    frontpage.title = "Welcome to Fly Jamaica Airways"
    frontpage.description = (
                    "Fly Jamaica Airways, Flying to Kingston ",
                    "(Jamaica), ",
                    "Georgetown (Guyana), New York and Toronto. ",
                    "Fly Jamaica Airways is an airline headquartered ",
                    "in Kingston, Jamaica, with flight operations at ",
